...
export const OFFER_OBJECT = [
   { id: 1, type: 'text', name: 'title', placeholder: 'plante, meuble-tv, lampe...', label: 'Titre de mon annonce :' },
   {
      ...
      label: 'Decriptif de mon annonce :',
   },
   ...
   },
   {
      ...
      defaultValue: selectObjectCondition[0],
...
export const ASK_SERVICE = [
   { id: 1, type: 'text', name: 'title', placeholder: 'plante, meuble-tv, lampe...', label: 'Titre de mon annonce :' },
   {
      ...
      type: 'textarea',
      name: 'description',
      placeholder: "Je recherche quelqu'un pour m'aider à fixer une étagère.",
      label: 'Decriptif de mon annonce :',
   },
   { id: 3, type: 'text', name: 'location', placeholder: 'Bruxelles, Namur, Liège...', label: "Lieu de l'annonce :" },
];
...
export const OFFER_SERVICE = [
   { id: 1, type: 'text', name: 'title', placeholder: 'plante, meuble-tv, lampe...', label: 'Titre de mon annonce :' },
   {
      ...
      type: 'textarea',
      name: 'description',
      placeholder: 'Disponible pour des travaux de petit bricolage.',
      label: 'Decriptif de mon annonce :',
   },
   { id: 3, type: 'text', name: 'location', placeholder: 'Bruxelles, Namur, Liège...', label: "Lieu de l'annonce :" },
];
