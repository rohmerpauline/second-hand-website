    ...
    return (
        <>
            <button
                ...
                className={
                    button === buttonContent.btnObject ? createAddStyle.btniconeselected : createAddStyle.btnicone
                }
                data-tip
                data-for='object-tip'
                data-delay-show='500'
            ...
            <button
                ...
                className={
                    button === buttonContent.btnService ? createAddStyle.btniconeselected : createAddStyle.btnicone
                }
                data-tip
